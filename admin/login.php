...
<?php
    ...
    if (isset($_POST['submit']))
    {
       ...
       $sql="select * from tbn_account where 
               username='$username' and password='$password' and typeaccount_id=1";
       ...
       $count = mysqli_num_rows($res);
        ...
        if($count==1)
        {
            $_SESSION['login']="<p class='card-description' style='color:green;'> Login Successful</p>";
            $_SESSION['user']=$username;
            echo("<script>location.href = '".SITEURL."admin/index.php';</script>");
        }
        else{
            $_SESSION['login']="<p class='card-description' style='color:green;'> Username or password incorrect</p>";

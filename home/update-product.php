              ...
              <div class="card">
                <div class="card-body">
                  ...
                  <form class="forms-sample">
                    ...
                    <div class="form-group row " <?php if($status=="waiting"){echo (" style='display: none;'");} else {echo (" style='display:flex;'");} ?> >
...
<?php
 if(isset($_POST['submit']))
 {
    ...
    if(isset($_FILES['image']['name']))
     ...
     name='$name',price=$price,description='$description',status='$status',product_category_id=$type_product_id, image='$image_name' where id='$id'";
